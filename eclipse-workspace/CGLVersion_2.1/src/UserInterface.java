...
public class UserInterface {
	...
	**********************************************************************************************/
	...
	private Grid oddGameBoard;		// The Board for odd frames of the animation
	private Pane oddCanvas = new Pane();			// Pane that holds its graphical representation
	
	private Grid evenGameBoard;	// The Board for even frames of the animation
	...
	**********************************************************************************************/
	...
	private void loadImageData() {
		...
		System.out.println(oddGameBoard.toString());
...
//			evenCanvas=new Pane();
			...
			oddGameBoard.setBoard(evenGameBoard.generateNextGeneration(evenGameBoard.getBoard()));
			oddCanvas=new Pane();
			oddGameBoard.fillTheCanvas(oddCanvas);
			window.getChildren().add(oddCanvas);
			toggle=!toggle;
...
//			oddGameBoard.fillTheCanvas(oddCanvas);
			window.getChildren().remove(oddCanvas);
			evenGameBoard.setBoard(oddGameBoard.generateNextGeneration(oddGameBoard.getBoard()));
			evenCanvas=new Pane();
